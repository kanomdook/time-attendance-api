(function () {
  ...
  EmployeeprofilesController.$inject = ['$scope', '$state', '$window', 'Authentication', 'employeeprofileResolve', 'FileUploader', '$timeout', 'CompaniesService'];

  function EmployeeprofilesController($scope, $state, $window, Authentication, employeeprofile, FileUploader, $timeout, CompaniesService) {
    var vm = this;
