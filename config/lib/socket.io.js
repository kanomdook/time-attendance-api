...
//             if (false) return next(new Error('sessionId was not found in socket.request'), false);
...
//                 if (false) return next(new Error('session was not found for ' + sessionId), false);
